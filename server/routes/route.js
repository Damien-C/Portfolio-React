...
router.get('/projectList', (req, res) => {
    connection.query(`SELECT Project.name, date_format(Project.dateStart, '%b. %Y') dateStart, date_format(Project.dateEnd, '%b. %Y') dateEnd, ProjectImage.fileName FROM portfolio.Project
